...
public class ModSoundEffect
{
    ...
    public void Play() => PlayOn(e => ModAudio.PlaySoundGlobal(
        e.Sound,
        volumeAdd: _globalVolumeAdd + e.VolumeAdd,
        pitchVariation: _globalPitchVariation + e.PitchVariation,
        basePitch: e.BasePitch));

    public void PlayInRun() => PlayOn(e => ModAudio.PlaySoundInRun(
        e.Sound,
        volumeAdd: _globalVolumeAdd + e.VolumeAdd,
        pitchVariation: _globalPitchVariation + e.PitchVariation,
        basePitch: e.BasePitch));

    private void PlayOn(Action<ModSoundEntry> play) => play(PickRandom());
